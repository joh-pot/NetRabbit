...
internal class SynchronizedMessageHandlerSubscriberService : ISubscriberService<SynchronizedMessageHandler>
{
    private readonly IRabbitChannelFactory _rabbitChannelFactory;
    private readonly IConsumerService<SynchronizedMessageHandler> _syncConsumerService;

    public SynchronizedMessageHandlerSubscriberService
    (
        IRabbitChannelFactory rabbitChannelFactory,
        IConsumerService<SynchronizedMessageHandler> syncConsumerService
    )
    {
