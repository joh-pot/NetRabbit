...
{
    internal class SynchronizedMessageHandlersHostedService<T> : IHostedService
    {
        private readonly IEnumerable<SynchronizedMessageHandler<T>> _syncHandlers;
        private readonly ISubscriberService<SynchronizedMessageHandler<T>>? _subscriberService;
        private CancellationTokenSource? _cts;
        public SynchronizedMessageHandlersHostedService
        (
            IEnumerable<SynchronizedMessageHandler<T>> syncHandlers,
            ISubscriberService<SynchronizedMessageHandler<T>>? subscriberService
        )
        {
